...
function solution($id_list, $report, $k) {
    $answer = array();
    $split_report = array();
    $split_report_array = array();


	for($i = 0 ; $i < count($report) ; $i++){
	
		//$split_report[] = explode(' ' , $report[$i]);

		$split_report =  explode(' ' , $report[$i]);
			
		array_push($split_report_array,$split_report);
...
$id_list = ['yum','hong','kim','yu'];
$report = ['yum hong','hong yum','kim hong','yu kim','yu kim','yu hong'];
$k = 2;
